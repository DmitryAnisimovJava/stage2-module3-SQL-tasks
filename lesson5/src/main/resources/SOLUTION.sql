...
SELECT id, name, birthday, groupNumber FROM student WHERE DATE_DIFF('YEAR', birthday, '2000-10-10') > 20;

SELECT id, name, birthday, groupNumber FROM student WHERE groupNumber = 10 AND DATE_DIFF('YEAR', birthday, '2000-10-10') < 20;

SELECT id, name, birthday, groupNumber FROM student WHERE groupNumber = 10 AND DATE_DIFF('YEAR', birthday, '2000-10-10') < 20;

SELECT id, name, birthday, groupNumber FROM student WHERE name LIKE 'Mike%' OR groupNumber IN (4, 5, 6);

SELECT id, type_id, amount, student_id, payment_date FROM payment WHERE DATE_DIFF('MONTH', payment_date, '2000-10-10') <= 8;
